...
$redirect_uri = "https://node111.webte.fei.stuba.sk/auth/oauth2callback.php"; // Redirect URI for the OAuth2 callback. Must match the one in the Google Cloud Console.
...
if (isset($_GET['code'])) {
    ...
    $redirect_uri = 'https://node111.webte.fei.stuba.sk/auth/restricted.php'; // Redirect to the restricted page or dashboard.
